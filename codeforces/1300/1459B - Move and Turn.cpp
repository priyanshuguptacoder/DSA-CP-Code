/*
    ...
    Submission At : 2026-08-31 23:04:27
*/
...
void solve() {
    ...
    int k = n / 2;
    if(n % 2 == 0){
        //Agar even hai toh usme ham ye kar sakte hai same number of left and same number of right honge
        cout << (k + 1) * (k + 1) << endl;
    }
    else{
        //Agar odd hai toh ek left or right me yek jayde hoga usme do option honge ek me left jayde le lo dushre case me right ko jayde le lo
        cout << 2 * (k + 1) * (k + 2) << endl;
    }
}
