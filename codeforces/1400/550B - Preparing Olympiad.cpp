/*
    ...
    Submission At : 2026-09-06 02:06:42
*/
...
void solve() {
    ...
    int ans = 0;
    loop(mask, 0, (1 << n)){
        ll sum = 0, mini = 1e18, maxi = -1, cnt = 0;
        ...
        if(cnt < 2 || sum < l || sum > r || maxi - mini < x){ //Atleast 2 problems, Sum must be in [l, r], Hardest - easiest >= x
            continue;
        }
        ans++;
    }
